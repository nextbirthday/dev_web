...
<%
List<Map<String, Object>> getBoardList = (List<Map<String, Object>>) request.getAttribute("boardList");
    ...
    <form id="uf_board" method="post" enctype="multipart/form-data">
      ...
      <table align="center" width="650px" height="280px">
        <tr>
          ...
          <td width="580px">
            <input id="bm_title" value="글제목" name="bm_title" class="easyui-textbox">
          </td>
        </tr>
        <tr>
